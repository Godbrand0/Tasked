      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px]" style={{ gap: 32, alignItems: "start" }}>
          ...
          <div>
            ...
            {/* GitHub reference — a small icon-link also sits in the meta row above, but that's easy to miss */}
            {task.githubRepo && (
              <Section title="Reference">
                <a href={task.githubRepo} target="_blank" rel="noopener noreferrer"
                  style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 14, color: "var(--secondary-light)", textDecoration: "none", wordBreak: "break-all" }}>
