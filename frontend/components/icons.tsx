// Shared stroke-icon set (24×24 viewBox, round caps, 2px stroke) — one
// visual language used everywhere instead of mixing this set with emoji.
// Every icon takes an optional `size` (defaults preserve each icon's
// original usage) so the same component works inline in a badge (~12px)
// or as a large empty-state/hero icon (~48px+).
...
export function IconLock({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="11" width="18" height="11" rx="2" fill="currentColor" fillOpacity="0.12" />
...
export function IconCoins({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconVote({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M18 20V10" />
      <path d="M12 20V4" />
...
export function IconBitcoin({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconTrophy({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 4h10v6a5 5 0 0 1-10 0V4z" fill="currentColor" fillOpacity="0.15" />
      <path d="M7 5H4a2 2 0 0 0 2 4M17 5h3a2 2 0 0 1-2 4" />
    </svg>
  );
}

export function IconLandmark({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconBallot({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="9" width="18" height="12" rx="2" />
      <path d="M12 3v10M9 9l3-3 3 3" />
...
export function IconMegaphone({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 11v3a1 1 0 0 0 1 1h2l4 5V6l-4 5H4a1 1 0 0 0-1 1z" />
      <path d="M15 8a4 4 0 0 1 0 8M18 4a9 9 0 0 1 0 16" />
    </svg>
  );
}
...
export function IconHandRaised({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 13V5a1.5 1.5 0 0 1 3 0v6" />
      <path d="M11 10.5V3.5a1.5 1.5 0 0 1 3 0V11" />
      <path d="M14 10.5V5a1.5 1.5 0 0 1 3 0v9" />
      <path d="M17 12.5V9a1.5 1.5 0 0 1 3 0v7c0 3.5-2.5 6-6 6h-2c-2.5 0-4-1-5.5-3L4 15c-.6-.8-.4-1.8.4-2.3.7-.4 1.6-.3 2.1.4L8 15" />
    </svg>
  );
}

export function IconWaves({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconMedal({ size = 18, color = "currentColor" }: IconProps & { color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="15" r="6" />
      <circle cx="12" cy="15" r="2.5" fill={color} stroke="none" />
      <path d="M9 10 6 2M15 10l3-8M6 2h3l3 3 3-3h3" />
    </svg>
  );
}
...
export function IconGraduationCap({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Animated loading indicator — pairs with the .icon-spin keyframe in
// globals.css. Used as LoadingState's default icon instead of an emoji.
export function IconSpinner({ size = 18 }: IconProps) {
  return (
    <svg className="icon-spin" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
